import { StyledFunctionsList, StyledProductCard, StyledProductCardCost, StyledProductCardCostDescription, StyledProductCardCostTitle, StyledProductCardLinkBtn, StyledProductCardTitle, StyledProductFunction, StyledProductsBlockHeader, StyledProductsBlockSubtitle, StyledProductsBlockTitle, StyledProductsBlockWrapper, StyledProductsCardContent } from "./styles";
            ...
            <StyledProductsCardContent>
                {products.map(p => <StyledProductCard>
                    ...
                    <StyledProductCardCost>
                        ...
                        <StyledProductCardCostDescription> / год</StyledProductCardCostDescription>
                    </StyledProductCardCost>
                    <StyledFunctionsList>
